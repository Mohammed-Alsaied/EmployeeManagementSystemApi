...
[ApiController]
public class AuthenticateUsersController : ControllerBase
{
    ...
    public AuthenticateUsersController(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, IEmailService emailService)
    {
    ...
    [HttpPost]
    [Route("Register")]
    public async Task<IActionResult> Register([FromBody] RegisterModel model, [Required] string role)
    {
